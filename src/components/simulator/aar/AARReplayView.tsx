  ...
  return (
    <div className="py-4 space-y-4">
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" onClick={onBack} className="gap-1.5 hover:bg-muted/50 transition-colors">
          <ArrowLeft className="w-4 h-4" /> Back to list
        </Button>
        <h2 className="text-lg font-bold text-foreground">{record.traineeName}</h2>
